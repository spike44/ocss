...
/**
 * Servlet implementation class SearchMemberForEmailServlet
 */
public class SearchMemberForEmailServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public SearchMemberForEmailServlet() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			List<MemberVO> list = memberService.selectmemberemail(s);
			if(list != null) {
