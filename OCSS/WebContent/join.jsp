...
<form class="cmxform" id="signupForm" method="get" action="">
	<fieldset>
		...
		<p>
			...
			<input class= button type="button" name="idCheck" value="중복확인" onclick="checkId()">
		</p>
		<p>
		...
		<p>
			<label for="agree">내부 규정에 동의하십니까?</label>
			<input type="checkbox" class="checkbox" id="agree" name="agree" />
		</p>
		
		<p>
			<input class="button" type="button" name="doJoin" value="회원가입"/>
		</p>
	</fieldset>
</form>
