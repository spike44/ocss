				...
				<form id="deleteForm" action="" name="deleteForm" method="post">
					<table width="44%" border="0" align="right">
						<tr>
							...
							<td><input class="button" type="button" id="deleteMember"
								name="deleteMember" value="회원탈퇴" onclick="dodelete()" /> <input
								class="button" type="button" id="cancel2" name="cancel2"
								value="취소" onclick="docancel()" /></td>
						</tr>
