						...
						<tr>
							...
							<td><c:if test="${p.powerList == 1}">
							  ...
							  <div align="center">구매자</div>
									...
									<td> <div align="center">
									  <input class="button orange medium" type="button" id="memberButton" value="보기" onclick="location.href='detailMember.do?memberId=${p.memberId}'" />
						  </div></td>
					  </tr>
					</c:forEach>
				</table>
