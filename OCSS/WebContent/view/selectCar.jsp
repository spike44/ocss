	...
	<div id="left">
		...
		<div class="text">
			...
			<center>
			    ...
			    <center>
				<input class="button" type="button"name="serchCar" value="차량 검색" align="center" onclick="searchCar()"/><br /> <br />
			    </center>
				...
				<br />
				  ...
				  <br /> 
				  <input class="button" type="button" name="keepingCar" value="관심상품 담기" onclick="keepingCar()" /> 
				  <br /> 
				  <br />
				  </div>
	    </div>
