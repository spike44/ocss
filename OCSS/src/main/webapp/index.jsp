...
<div id="header">
  ...
  <div id="slider" class="nivoSlider">
                <img src="<%=request.getContextPath() %>/img/header1.jpg" alt="" />
                <img src="<%=request.getContextPath() %>/img/header2.jpg" alt=""/>
                <img src="<%=request.getContextPath() %>/img/header3.jpg" alt="" />
				<img src="<%=request.getContextPath() %>/img/header4.jpg" alt="" />
            </div>
        </div>
...
<div id="footer">
  ...
  <p align="center"><a href="#"><img src="<%=request.getContextPath() %>/img/dis.png" alt="" width="186" height="39" /></a></p>
